 ...
 */
public class TravisTestAdapterConsumer extends ScheduledPollConsumer {
    private Logger LOG = LoggerFactory.getLogger(TravisTestAdapterConsumer.class);

    private final TravisTestAdapterEndpoint endpoint;


    public TravisTestAdapterConsumer(final TravisTestAdapterEndpoint endpoint, final Processor processor) {
